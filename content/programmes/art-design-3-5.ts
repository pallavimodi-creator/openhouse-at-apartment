...
const artiverseUnits: ArtiverseUnit[] = [
  // ── Colourful Papers ──
  {
    ...
    whatChildrenMake: "Accordion fans · fold-out greeting cards · accordion creatures",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Faces · animals · simple scenes",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Mosaic animals · landscapes · letters of own name",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Paper chains · loop garlands · chain animals",
    days: 2,
    abilitiesCovered: ["Tool Precision", "Names and recognises", "Explores Artistic Concepts"],
  ...
  // ── Crayons ──
  {
    ...
    whatChildrenMake: "Doodle pages · marks that turn into things",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Coloured worksheets · child's own outline drawings",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Mixed-colour swatches · scenes that need new colours",
    days: 2,
  ...
  // ── Watercolour ──
  {
    ...
    whatChildrenMake: "Greeting cards with hand-print as the central image",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Greeting cards with finger-print pattern or figures",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Skies · landscapes · cloud scenes",
    days: 2,
  ...
  },
  {
    ...
    whatChildrenMake: "Dot paintings · pointillist scenes · small creatures",
    days: 2,
    abilitiesCovered: ["Tool Precision", "Drawing Figures and Patterns", "Integrating Artistic Choices"],
  ...
  },
  {
    ...
    whatChildrenMake: "Splatter trees · firework scenes · abstract bursts",
    days: 2,
 ...
 * Artiverse and Artistotle alternate as long blocks; 42 sessions covered;
 * S43-60 reserved.
 */
