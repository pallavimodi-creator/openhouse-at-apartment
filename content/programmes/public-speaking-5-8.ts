...
const playgroundActivities: Record<string, CurriculumActivity> = {
  ...
  "train-of-thoughts": {
    ...
    players: "3–8 children · 1 teacher",
    duration: "10 min",
    goal: "the child draws cards, completes each speaking task, and builds a train of 9 cards — 3 of each colour.",
    steps: [
      "place three coloured card decks in the centre — each colour a different speaking task.",
      "on their turn, the child draws one card and completes the speaking task.",
      "the child lays the completed card face-up in front of them — this line is their train.",
      "play passes to the next child.",
      "keep going until a child collects 3 cards of each colour, 9 in total.",
    ],
    endsWhen: "a child makes a set of 3 cards of each colour, 9 cards total.",
    easierVariation:
      "the child collects a set of the same colour only — no action cards used.",
    harderVariation:
