...
const ARTISTOTLE_PAGES = [
  ...
  "/artistotle-book/06-eric-carle-project-1.png",
  "/artistotle-book/07-eric-carle-project-2.png",
  "/artistotle-book/08-lois-ehlert-cover.png",
  "/artistotle-book/09-lois-ehlert-project-1.png",
  "/artistotle-book/10-lois-ehlert-project-2.png",
  "/artistotle-book/11-taro-gomi-cover.png",
  "/artistotle-book/12-taro-gomi-about.png",
  "/artistotle-book/13-taro-gomi-project-1.png",
  "/artistotle-book/14-taro-gomi-project-2.png",
];
