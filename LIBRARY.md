...
1. Coloured beads sit in a bowl or box in the centre.
2. On their turn, a child picks one bead without looking, compares it to their grid, and places it if it matches.
3. No match = bead goes back.
4. First to finish a row or grid wins.

**Variations**

- **Variation 1 — Picture matching** — Child draws a picture card from a deck and places it on the matching colour grid. If no match, discard. First to finish a row or grid wins.
- **Variation 2 — Pattern Bingo** — Teacher calls out a colour + pattern combination (e.g. "yellow straight lines"). Children mark if present. First to finish a row or grid wins.

**Difficulty**

- **Easy:** match colours only — with beads or picture cards.
- **Medium:** Pattern Bingo — teacher calls out a colour + pattern combination and children mark if present.
- **Hard:** children play Bingo without teacher's cues — each child takes a turn to call out a colour + pattern.
...
2. Children take turns flipping two cards on each turn.

**Variations**

- **Variation 1 — Colour matching** — Each player flips two Colour Cards on their turn. If both cards are the same colour, they keep the pair. If not, they flip the cards back. The player with the most pairs at the end wins.
- **Variation 2 — Colour Mixing cards** — Each player starts with an Easy Mixing Card. On their turn, flip two Colour Cards from the grid. If the flipped colours match the formula on the Mixing Card, they keep the cards — if not, they place them back.
- **Variation 3 — Missing mixing card** — The teacher gives a Medium or Difficult Mixing Card with either 1 or 2 colours missing. Children find the matching pair by flipping 2 cards.
...
1. Children sew through templates using shoelaces.
2. Running Stitch = dashed line.
3. Backstitch = continuous joined line.
4. Whip stitch = over the edges in a loop.
5. Pattern Stitching = combines stitch types in a design of the child's choosing.
...
1. Each child builds a subject from geometric pieces silently while their team guesses what it is.

**Variations**

- **Variation 1 — Child's choice** — The child picks which subject they want to create from the Shape Card and the other children guess.
- **Variation 2 — Relay / race** — The group splits into teams and the teams compete to make the most subjects — whichever team finishes a card, or a set number of cards, first wins.
...
1. One card placed centrally.
2. Children follow step-by-step instructions simultaneously.
3. Educator gives extension challenge after completion.
...
1. Teacher shows a scene card or places multiple line/texture cards in a row.
2. Educator names a texture, line/shape, or texture.
3. Child finds it, then draws.

**Difficulty**

- **Easy:** Easy cards (scene cards) shown — child draws chosen object.
- **Medium:** Use of Texture or lines/shapes cards.
- **Hard:** Any card shown 30 seconds then removed, drawn from memory.
...
1. Set up board game.
2. Roll dice, move, land on an art zone.
3. Draw a challenge card (draw, colour, build or mixed media) and complete it within the time limit.

**Variations**

- **Cooperative variation** — The whole group plays as a team. Each child takes a turn rolling the dice, and all the children do the same challenge as on the card drawn by that child. Then the next player rolls.
...
1. Sketch zone (Yellow tile/card) — children complete a simple sketch activity.
2. Colour zone (Teal tile/card) — children complete a colouring activity on given sheets.
3. Build zone (Pink tile/card) — children build a structure using blocks or pipe cleaners.
4. Mixed media zone (Light blue tile/card) — children complete the given activity using mixed mediums.
...
1. One child is the describer.
2. The describer describes the card without naming the subject.
3. The other children draw what they hear.
4. After everyone is done, the describer picks the drawing that best matches what they had in mind.
5. Variation — the child invents an imaginary subject and describes it while drawing simultaneously — for example, a whale with the body of a horse.
...
1. The teacher reads out the prompt to draw.
2. All children draw simultaneously for a set time, then reveal.
3. Example prompt — "something that starts with the letter C." If two or more children draw the same thing, they each score 0; a unique drawing scores a point.
4. Bonus points for the funniest or most artistic drawing, voted by the group.
5. Variation — children draw individually or as a team taking turns.
...
- **What children make:** Lines with watercolour
...
- **What children make:** Leaf printing sunflower
...
- **What children make:** Warm and cool colours
...
- **What children make:** Shape monsters
...
- **What children make:** Pear collage
...
- **What children make:** Abstract circles and shapes
...
- **What children make:** Flower pots
...
1. Teacher shows image card of finished artwork.
2. Children examine and name the tool/medium.
3. Group discusses.
4. Teacher confirms and names the mark characteristic.

**Variations**

- **Variation — Making** — After guessing, children make the drawing using the identified tool or medium.

**Difficulty**

- **Easy:** identify tool or medium only.
- **Medium:** use that tool or medium to replicate the drawing.
- **Hard:** use the tool or medium to draw creatively.
...
1. Card placed centrally.
2. Follow step-by-step.
3. At 8-12, educator always adds extension challenge after completion — e.g. 'change angle by 45 degrees' or 'redraw at twice the scale.' Portrait and Landscape card sets available.

**Difficulty**

- **Easy:** B1 cards, visible throughout.
- **Medium:** B1 or B2, educator names one thing to observe.
- **Hard:** B2 card shown for a minute then removed, drawn from memory. Extension required.
...
1. Two ways to play — see variations.

**Variations**

- **Variation 1 — Build and guess** — Each child builds a subject from geometric pieces silently while their team guesses what it is. Child's choice: the child picks which subject they want to create from the Shape Card and the other children guess. Relay / race: the group splits into teams and the teams compete to make the most subjects — whichever team finishes a card, or a set number of cards, first wins.
- **Variation 2 — Composition from cues** — Each child builds a composition from transparent geometric pieces based on teacher cues (for example: teacher says "build a composition with one dominant shape supported by two smaller ones"). After building, sketch the arrangement on paper capturing proportions and negative space. Compare sketch to tile arrangement.

**Difficulty**

- **Easy:** Variation 1 — build and guess.
- **Medium:** Variation 2 — standard gameplay.
- **Hard:** The opposite team chooses specific geometric shapes to be used, or gives cues instead of the teacher.
...
2. Roll dice, move, land on an art zone.
3. Draw a challenge card (draw, colour, build or mixed media) and complete it within the time limit.
4. After completing the challenge, the child gives one sentence explaining one decision they made.
...
1. Children take turns flipping two cards.
2. Match = keep pair.
3. No match = flip back.
4. Variation 2: each child has a Difficult Mixing Card primary and flips to find formula colours.
5. Palette Build variation: educator names mood/time of day, children select 3-4 cards as palette.

**Difficulty**

- **Easy:** colour recognition only.
- **Medium:** Difficult cards.
- **Hard:** Palette Build, child names colour and explains behaviour in painting.
...
- **What children make:** Tomato Composition
...
- **What children make:** Abstract Waves
...
- **What children make:** Donut Painting
...
- **What children make:** Warhol-style Cats
...
_Roll Call · facilitated · card: Brain_
...
1. Sit in a circle.
2. Teacher reads one opening sentence — the last word is a bold starter word the next child must open with.
3. The chain continues around the circle.
4. If a child cannot continue within 5 seconds, they say "pass" and the next child continues.

**Materials**

- Opening-sentence prompt deck

**prompts — last word is the starter for the next child**

1. I saw a puppy near my building gate → starter: gate
2. We went to the park in the evening → starter: evening
3. My friend was feeling very happy → starter: happy
4. I ran home because it started to rain → starter: rain
5. My mother called me in the morning → starter: morning
6. We stopped playing because it got dark → starter: dark
7. I felt hungry after coming from school → starter: school
8. My father came home very late → starter: late
9. We were excited because it was a holiday → starter: holiday
10. I laughed because my friend was funny → starter: funny
11. We sat quietly because the teacher was angry → starter: angry
12. I woke up early on a Sunday → starter: Sunday
...
_Roll Call · physical game · card: Body_

> I'm going to show a card. Your team has to become that object — using only your bodies. No speaking.

**How to play**

1. Children divide into teams of 3–4.
2. One child flips an object image card — visible to all teams.
3. All teams immediately form that object using their bodies.
4. No speaking.
5. Teams work together silently.
6. The teacher decides which team's version is most convincing.
7. That team flips the next card.

**Variations**

- **Formation guide** — The back of each card shows an illustration of how to form the object as a pair or a group. Teams try to match the illustrated formation.
- **Find your pair** — Cards come in matching pairs (table + chair, bowl + spoon, pen + paper). Each child draws one card without showing others. On the signal, everyone walks around forming their object using their body. When they find their matching pair, they link up. First pair to lock in wins.
...
**prompts — 15 pair blocks · card A + card B**

1. Pair 1 · chair (solo: glide · partner: one leg breaks) + table (solo: wobble · partner: set the table)
2. Pair 2 · spoon (solo: stir · partner: scoop) + bowl (solo: spin · partner: fill up)
3. Pair 3 · bed (solo: bounce · partner: tuck in) + pillow (solo: squish · partner: two pillows)
4. Pair 4 · tree (solo: grow · partner: a bird lands) + flower (solo: wilt · partner: a bee arrives)
5. Pair 5 · car (solo: accelerate · partner: traffic jam) + bus (solo: brake · partner: passengers board)
6. Pair 6 · bridge (solo: sway · partner: someone crosses) + arch (solo: crumble · partner: two arches meet)
7. Pair 7 · lamp (solo: flicker · partner: switch on) + book (solo: flip · partner: someone reads)
8. Pair 8 · house (solo: shrink · partner: chimney appears) + door (solo: creak · partner: knock knock)
9. Pair 9 · airplane (solo: soar · partner: flying in formation) + rocket (solo: launch · partner: countdown)
10. Pair 10 · bicycle (solo: pedal · partner: flat tyre) + wheel (solo: spin · partner: two wheels)
11. Pair 11 · guitar (solo: strum · partner: duet) + drum (solo: rumble · partner: drumstick snaps)
12. Pair 12 · umbrella (solo: inside out · partner: share) + rain (solo: pour · partner: puddle forms)
13. Pair 13 · ladder (solo: wobble · partner: someone climbs) + stairs (solo: crumble · partner: third step)
14. Pair 14 · toothbrush (solo: brush · partner: giant tooth) + tooth (solo: wobbly · partner: toothbrush arrives)
15. Pair 15 · camera (solo: zoom · partner: pose) + mirror (solo: crack · partner: three-way mirror)


### voice toss

_Roll Call · physical game · card: Voice_

> Before you throw the ball, call a volume. The catcher has to say any word at exactly that volume.

**How to play**

1. Children stand or sit in a circle.
2. Before throwing a soft ball, the thrower calls one of three volume levels.
3. The catcher must say any word at exactly that volume before throwing to someone new and calling a different level.
4. Three volume levels: Loud — full voice, fill the room
5. Medium — normal conversation voice
6. Whisper — barely audible, lean in to hear.

**Variations**

- **Sing / Laugh / Cry and Speak** — Before the throw, the thrower calls one of three modes — sing, laugh, or cry. The catcher says any word in that mode: sung to any tune, while laughing, or as if about to cry.
- **Volume Toss Circle** — The circle gradually moves up or down the volume scale — each catcher speaks one notch louder or one notch quieter than the last. After every 3 children, the teacher resets the cycle and the circle starts again from the beginning of the scale.
...
_Roll Call · physical game · card: Eyes_

> Walk around. When the music stops, find someone and hold eye contact until the music starts again.

**How to play**

1. Children walk around the space while music plays.
2. When the music stops, each child makes eye contact with someone nearby and holds it according to today's variation.

**Variations**

- **Hold it** — Both children hold eye contact until the music starts again. If a child looks away first, they sit out for one round.
- **Walk toward each other** — Two children who lock eyes walk toward each other — eyes must stay on each other for the entire walk.
- **Who blinks first** — After locking eyes, both children try not to blink. First to blink sits out for one round.
- **Make them laugh** — After locking eyes, children try to make the other person smile or laugh without touching them or speaking.
...
2. One player makes a small gesture with a small sound — for example, slowly raising one hand and humming softly.
3. Their neighbour copies exactly and passes it around.
4. Variations in what subtly changes are observed and discussed after.
5. Also watch for small unplanned sounds — sighs, clicks, breaths — these should be copied too.

**prompts — gesture + sound combinations**

1. Touch one shoulder slowly and hum one soft note.
2. Open your eyes wide and make a tiny gasp.
3. Scrunch your nose and sniff two times.
4. Wave one hand gently and whisper "hi."
5. Put your hands on your cheeks and say "oh!"
6. Raise both eyebrows and make a short "hmm."
7. Pat your knees two times and say "tap tap."
8. Clap once softly and smile wide.
9. Touch your chin and say "hmm hmm."
10. Wiggle your fingers and whisper "tickle tickle."
11. Stamp one foot lightly and say "thump."
12. Cover your mouth and make a tiny giggle.
13. Point to your ear and say "listen."
14. Make a surprised face and say "wow!"
15. Rub your hands together and say "ready ready."
16. Tilt your head to one side and hum softly.
17. Tap your elbow and make a quiet "pop."
18. Stretch both arms out and say "ta-da!"
19. Blink three times and make a soft "bloop."
20. Pat your shoulders and say "brrr."
21. Make a sleepy face and yawn quietly.
22. Lift one hand high and say "hello there!"
...
1. Children take turns.
2. One child picks a card from the deck without showing it.
3. On the card is a ticked object — a bell, a door, a cat, a kettle, a clap, a drum.
4. The child makes the sound of that object using only their voice and body.
5. The other children listen and guess.
6. First correct guess picks the next card.

**Variations**

- **Variation — Quartets** — Shuffle and deal 4 cards to each player. Place the rest face down in the centre. Goal: make sets of 4 matching cards of the same series (quartets). On your turn, ask any player for a series (e.g. nature, animals, vehicles) you need — if they have it, ask for the card by acting out or saying its sound. If you get the card, continue your turn. If not, draw one card from the centre and your turn ends. The first player to collect 1 or 2 full quartets wins.
...
1. Each child receives a laminated Script Flip card and an erasable marker.
2. They fill in the story template blanks.
3. When all blanks are filled, each child narrates their completed script.
4. For children who cannot yet write, the teacher scribes — child says the word aloud, teacher writes it in, then child narrates.

**Variations**

- **Write & perform — individual or as a team** — Children fill and perform their script solo, or work in small teams — one card shared, blanks filled together, each team member delivers a section of the narration.
...
1. Teacher places the Story Mat and the deck of story cards in 4 piles.
2. First child places their card and begins the story.
3. The next child picks a card from any pile, places it on the Story Mat, and continues the story line from where the previous child left off.
4. The tale builds card by card around the circle.
5. The child placing the last card ends the story, or the teacher ends it.

**Variations**

- **Variation — Mixed cards** — Teacher places all category cards in a single pile faced down. The player draws cards turn by turn, randomly.

**Difficulty**

- **Easy:** Educator provides an opening sentence.
- **Medium:** Variation 1 — children or teacher can choose a theme card for a child.
...
1. Divide children into a Performing Team and a Questioning Team.
2. The Performing Team draws one story — 6 cards — and lays them face-up in the story's printed order.
3. They have preparation time to build a story using the cards in that order.
4. They perform — roleplay and narration — within set time.
5. Questioning team asks questions using their Question Bands, and the Performing Team answers.
6. One player summarises in 2–3 sentences.
7. Roles rotate.

**Difficulty**

- **Easy:** Untimed — the Performing Team takes as long as they need to prepare.
- **Medium:** Timed challenge — preparation time is limited (e.g. 5 minutes on the clock).
- **Hard:** Timed preparation, and the Questioning Team is allowed to ask follow-up questions beyond the normal round — digging deeper into any answer.
...
**the 10 stories in the shuffle deck**

1. Story 1 — The Tortoise and the Hare (Aesop)
2. Story 2 — The Boy Who Cried Wolf (Aesop)
3. Story 3 — The Lion and the Mouse (Aesop)
4. Story 4 — The Emperor's New Clothes (Hans Christian Andersen)
5. Story 5 — The Ant and the Grasshopper (Aesop)
6. Story 6 — The Crow and the Pitcher (Aesop)
7. Story 7 — The Ugly Duckling (Hans Christian Andersen)
8. Story 8 — Androcles and the Lion (Aesop)
9. Story 9 — The Wind and the Sun (Aesop)
10. Story 10 — The Brahmin's Pot of Dreams (Panchatantra)
...
1. Each child draws a card from the expression / gesture deck.
2. The child then chooses to keep or discard the card — if they keep it, they incorporate that expression or gesture into a sentence they speak; if not, they discard it and wait for their next turn.
3. The group watches and calls out the feeling or meaning they see.
4. The round continues until every child has completed their set — 4 expressions and 4 gestures each.

**Variations**

- **Individual play** — Each child completes their own set of 4 expressions + 4 gestures on their own turns.
- **Team play** — Children play in teams. For each card, every member of the team says a different line using that same gesture or expression — a group performance of the same feeling.
...
- Body Talk expression and gesture card deck
...
1. Pieces start at the bottom of the gameboard.
2. The time board at the side maps speaking time to steps — e.g. 15 seconds = 1 step, 30s = 2, 45s = 3, 60s = 4, and so on.
3. Players can see the board so they can plan how long they want to keep speaking.
4. Teacher reads out a prompt from the digital deck in the app.
5. Player starts speaking on that prompt.
6. The timer runs.
7. Hesitation, repetition, or going off-topic stops the timer — the piece moves by the number of steps the time board allows for that clock reading.
8. Landing on a Slippery Step moves the piece back.
9. Landing on a Risk Step: player attempts a Risk Card challenge — completing it earns a Reward Card.
10. First individual / team to the top of the board wins.

**Variations**

- **Individual play** — Each player plays with their own piece. Their turn, their topic, their time.
- **Team play** — Teams share one piece on the board but turns are taken by team members — each member speaking on a different topic. Every member must take at least one turn before the team piece reaches the top.
...
1. Three coloured card decks are placed in the centre — each colour is a different type of speaking task.
2. On their turn, a child draws one card and completes the speaking task, laying the completed card face-up in front of them.
3. This line of completed cards is their train.
4. The child wins by making a set of 3 cards of each colour — a total of 9 cards.

**Variations**

- **Longest train** — At the end of the session, the child with the longest train — most cards completed in sequence — wins.

**Difficulty**

- **Easy:** Set of same colour only — no use of action cards.
- **Medium:** Use action cards.
- **Hard:** Use action cards + all cards in a set must belong to the same compartment and be of the same colour.
...
1. One child holds a card to their forehead without looking at it.
2. The group acts out what is on the card.
3. The child guesses what is on the card based on the group's enactment.

**Variations**

- **Body and face only** — No sounds, no words.
- **Body, face, and sounds** — Group can add sounds but not say the word.
...
_Playground · facilitated_

> Questioner steps outside. Group agrees on a hidden rule. Questioner returns and asks questions to figure out the rule.

**How to play**

1. Questioner steps outside or turns away.
2. Group secretly agrees on a hidden rule governing all their answers — for example, everyone ends every answer with the same word, or everyone answers as if they are the person sitting to their left.
3. Questioner returns and asks each player a question in turn.
4. After one full round, questioner states their theory.
5. Group responds: Warm (close) or Cold (not close).
6. Game ends when the questioner correctly identifies the rule.

**Variations**

- **Imposter** — Before the questioner returns, one group member secretly receives a different hidden rule (decided by a simple chit draw from a bag). That person is the imposter. The questioner must identify both the group's rule and the imposter.
...
- Simple chits (for imposter variation — two types: Rule and Imposter)

**reference prompts — hidden rules the group can agree on**

1. Use a colour word in every answer.
2. Include a number in every answer.
3. Start every answer with "I think."
4. End every answer with the same word.
5. Speak only in questions.
6. Give opposite answers.
7. Use only 3 words per answer.
8. Add an animal name in every answer.
9. Never use the word "I."
10. Always say "yes" before answering.
11. Include a food item in every answer.
12. Act and speak — add one action before answering.
13. Give only very short answers.
14. Give only long or detailed answers.
15. Stretch one word in every answer.
16. Smile while answering.
17. Speak like a robot.
18. Speak in a whisper.
19. Answer like a baby.
...
1. Teacher gives a sentence prompt to speak.
2. A child starts speaking.
3. Another player can choose to call "reverse gear" on a specific word in between.
4. The child then has to say the opposite of what was originally said, or change the original word to a different word, continuing from that point.
5. For example, a player says "I love eating mangoes." Another child calls "reverse gear on I." The player repeats the sentence — "You love eating mangoes."
...
- Reverse Gear prompt deck (app)

**prompts — statements to reverse**

1. I always like playing in the park.
2. We usually eat dinner together at home.
3. My friend often plays cricket after school.
4. My mother always wakes up early.
5. My father sometimes watches TV at night.
6. My grandmother usually tells stories before bed.
7. My uncle often travels by car.
8. I usually choose chocolate ice cream.
9. We often play games in the evening.
10. My friend usually sits quietly in class.
11. My mother cooks food at home every day.
12. I always finish my homework quickly.
...
1. Teacher gives today's theme from the prompt bank.
2. Each child takes 30 seconds to think.
3. Children share in turn — beginning (when and where), main event (what happened), conclusion (how it ended or what it meant).
4. After each child shares, two peers each ask one genuine question connected to what was actually said.

**Difficulty**

- **Easy:** Familiar themes, teacher models with their own experience first.
- **Medium:** Standard themes, no model.
- **Hard:** Abstract or challenging themes, no preparation time.

**Materials**

- App for theme prompts

**prompts — themes to share about**

1. A time I lost something at home.
2. A time I met a new friend.
3. A day I went to a birthday party.
4. A time I got hurt while playing.
5. A time I helped someone at home.
6. A day I travelled with my family.
7. A time I forgot something important.
8. A time I shared my toys.
9. A day I stayed at home all day.
10. A time I saw something new outside.
11. A time I felt very excited.
12. A time I had to wait for something.


### magic box narratives
...
1. Each child reaches into the Magic Box without looking and draws one object.
2. Children build a story around the drawn object — beginning, middle, end.

**Difficulty**

- **Easy:** Teacher provides a sentence frame: "One day, [object] was..."
...
2. Child pitches their superpower to the class.
3. The group votes — useful or useless.
4. Child responds to one challenge question from the group.

**Difficulty**

- **Easy:** 1 minute prep, teacher provides the opening: "My superpower is..."
...
1. A superhero who can fly anywhere.
2. A superhero who can talk to animals.
3. A superhero who can run very fast.
4. A superhero who can become invisible.
5. A superhero who can clean anything instantly.
6. A superhero who can fix broken toys.
7. A superhero who can find lost things.
8. A superhero who can make food quickly.
9. A superhero who can control rain.
10. A superhero who can carry heavy things.
11. A superhero who can light up dark places.
12. A superhero who can build things quickly.
...
1. Sit in a circle.
2. Teacher reads one opening sentence from the prompt bank — the last word is a bold starter word the next child must open with.
3. The chain continues.
4. If a child cannot continue within 5 seconds, they say "pass" and the next child continues.
5. At 8–12, no starter word may repeat across the whole chain.
...
1. I missed the bus because I woke up late → starter: late
2. We stayed indoors because it was too hot → starter: hot
3. My friend was nervous before the match → starter: match
4. I felt proud after finishing my project → starter: project
5. We reached the mall in the evening → starter: evening
6. I got tired after playing in the ground → starter: ground
7. My teacher smiled because I answered correctly → starter: correctly
8. We stood quietly during the assembly → starter: assembly
9. I felt excited before going on a trip → starter: trip
10. My friend was upset after losing the game → starter: game
11. We started laughing because something was funny → starter: funny
12. I stayed back after school for a practice → starter: practice
...
5. Medium — normal conversation voice
6. Whisper — barely audible, lean in to hear.
7. At 8–12, the thrower may also name a word to stress: "Medium — and stress the last word."
...
- **Hold it** — Both children hold eye contact until the music starts again. If a child looks away first, they sit out for one round.
- **Walk and exchange** — Two children who lock eyes walk toward each other without breaking contact and exchange one sentence before music resumes.
- **Who blinks first** — After locking eyes, both children try not to blink. First to blink sits out for one round.
- **Make them laugh** — After locking eyes, children try to make the other person smile or laugh without touching them or speaking.
...
5. The other children listen and guess.
6. First correct guess picks the next card.
7. After a correct guess, the child explains one specific mark-quality of their sound — pitch, rhythm, attack — that made it recognisable.
...
1. First child places their card and begins the story.
2. The next child picks a card from any pile, places it on the Story Mat, and continues the story line from where the previous child left off.
3. The tale builds card by card around the circle.
4. The child placing the last card ends the story, or the teacher ends it.
5. At the end, the children give their story a title.

**Variations**

- **Transition cards** — Use transition cards alongside the story cards — when a child places one, they use the word or phrase on it to link their line to the previous one (e.g. "meanwhile…," "suddenly," "later that day"). One child narrates the full story at the end.
- **Theme dice** — The teacher rolls the theme dice to set the theme for the story. All children keep their contributions inside that theme. One child narrates the full story at the end.
- **Re-arrange the story** — After the first telling, the teacher places the beginning / middle / end arrow cards over the row and interchanges them — the group has to re-tell the story in the new order using the same cards. One child narrates the rearranged story at the end.

**Difficulty**

- **Easy:** Educator gives opening sentence.
- **Medium:** Standard play, players choose their cards.
- **Hard:** Use the theme dice — teacher rolls and all children keep their contributions inside the rolled theme.
...
1. Divide into Performing Team and Questioning Team.
2. The Performing Team draws one story — 6 cards — and lays them face-up in the story's printed order.
3. They have preparation time to create and prepare their performance.
4. Perform within set time.
5. Questioning team asks questions using Question Bands — at least one Why and one How — and the Performing Team answers.
6. One player summarises in 2–3 sentences.
7. Roles rotate.
...
- **Easy:** Untimed — the Performing Team takes as long as they need to prepare.
- **Medium:** Timed challenge — preparation time is limited (e.g. 3–5 minutes on the clock).
- **Hard:** Timed preparation, and the Questioning Team is allowed to ask follow-up questions beyond the normal round — digging deeper into any answer.
...
1. Each player notes their topic from the digital topic deck on their topic card.
2. Children pick any 5 puzzle cards from the shuffled deck placed face down by the teacher.
3. Teacher gives out any 2 action cards to each player.
4. On each turn, a child places one puzzle card on the Puzzle Board following the order (Topic, Opening, Argument, Evidence, Conclusion).
5. During play, players use the action cards given to Swap / Steal / Stop and fill the puzzle board with cards.
6. After all puzzle cards are placed, the child delivers their speech using the cards placed on the board.
7. One token is awarded for each puzzle card successfully used in a sentence.

**Variations**

- **Variation — Ability lanyard** — Teacher assigns a lanyard of a specific ability to the player, which the child focuses on while delivering their speech. The child earns bonus tokens for correctly using the assigned ability.
...
1. Choose one pair to start as the Investors.
2. This role rotates every round.
3. Form teams of 2–3 children.
4. Investors draw a Problem Card that presents a problem.
5. Each team receives 3 Solution Cards.
6. Teams select 1 Solution Card from their hand that they feel best matches the Problem Card, and prepare their pitch.
7. Each team pitches to the Investors.
8. The Investors are allowed to ask questions.
9. The Investors evaluate and award tokens to each team based on the structure of the pitch and how convincing it was.
...
1. Each player is given a meeple and a set amount of tokens.
2. Each player rolls the dice, moves, and follows the action on the block they land on.
3. The player draws a level-based challenge card or a fortune card, or does the simple action mentioned on the block.
4. Completing the challenge or action earns the player tokens.
...
3. This line of completed cards is their train.
4. The child wins by making a set of 3 cards of each colour — a total of 9 cards.
5. At 8–12, no notes are permitted at any difficulty level.
...
- **Easy:** Standard gameplay with no time limit.
- **Medium:** Standard gameplay within set time.
- **Hard:** With time limit — player asked to make sentences after guessing.
...
5. Group responds: Warm (close) or Cold (not close).
6. Game ends when the questioner correctly identifies the rule.
7. Post-reveal: group identifies the single most useful question asked and explains why.
8. At 8–12, the group may secretly change the rule halfway through.
...
1. Set up four quadrant mats, each with a slate showing a different challenge (e.g. speak only in questions, whisper, no hand gestures, rhyme every sentence).
2. Two performers start a scene in one quadrant.
3. Audience members hold Number Cards corresponding to quadrants.
4. At any point, an audience member raises their card to move a performer to that quadrant — the performer must immediately switch to that quadrant's challenge while staying in character.
5. Each performer has one Block Token to reject a move.
6. Penalty Tokens for breaking a quadrant rule.
7. Scene runs for a set time.
8. Post-scene: audience names the smoothest transition.

**Variations**

- **Variation 2** — Performers must rotate through all 4 quadrants during a single performance while still keeping the scene flowing.
...
**reference quadrant prompts — one per quadrant mat**
...
15. Sleepy
16. Windy
17. Speak in "n" word sentences
18. Sing your lines
19. Speak in questions
20. Curious
21. Bored
22. Anxious
23. Disgusted
...
1. I usually prefer working alone on my tasks.
2. We always follow rules during games.
3. My friend often tries new activities.
4. My mother usually plans everything in advance.
5. My father always finishes work on time.
6. My grandmother often chooses quiet places.
7. My uncle usually speaks softly in conversations.
8. I always organise my things before starting.
9. We often play in large groups after school.
10. My friend usually completes work very fast.
11. My mother always keeps the house neat.
12. I often wake up early without help.
...
1. Arrange in a circle and select a moderator.
2. Moderator draws a Topic Card and selects the topic.
3. Moderator selects two debaters.
4. Debaters draw For/Against chits.
5. Each debater draws a Challenge Card that introduces a constraint they must incorporate. 1 minute of preparation.
6. For and Against speak in turn, within set time.
7. Non-debating players ask questions.
8. Losing debater gets a Strike Card.
9. Two Strikes = become moderator.
10. Last debater standing wins.
...
3. Children share in turn — beginning (when and where), main event (what happened), conclusion (how it ended or what it meant).
4. After each child shares, two peers each ask one genuine question connected to what was actually said.
5. Mid-circle, teacher asks the whole group: "Before we continue — what is one thing someone said that you are still thinking about?"
...
1. A time I solved a problem by myself.
2. A time I worked with others in a group.
3. A time I tried something new.
4. A time I made a mistake and fixed it.
5. A time I changed my plan.
6. A time I helped someone without being asked.
7. A time I felt nervous before doing something.
8. A time I completed something difficult.
9. A time I had to be patient.
10. A time I learned something outside school.
11. A time I felt proud of something I did.
12. A time I had to share something important.
...
1. Each child reaches into the Magic Box without looking and draws one object.
2. Children build a story around the drawn object — beginning, middle, end.
3. Named character, problem connected to object, surprising ending required.
...
### l1 levers e1 — longer lever, less effort

_Experiment · physical game · card: L1 Levers e1_

> same load, different lever lengths. does it get easier to lift when the lever is longer?

**How to play**

1. Set up a simple lever across a T-connector fulcrum.
2. Hang a fixed load on one side and pull down on the other using a spring scale — first with a short arm (20cm), then a medium arm (30cm), then a long arm (40cm).
3. Each child takes at least one reading.
4. Record every reading in the result table.
5. First use: children discover the pattern.
6. Second use: children predict before reading — "I think the 40cm will need less force because last time it was the smallest number."

**Difficulty**

- **Easy:** Teacher reads the card. Child hangs load, pulls the spring scale and reads the number. Teacher writes.
- **Medium:** Child reads the card step by step, does the setup, and writes their own reading in the result table.
- **Hard:** Child predicts before each reading — "this one will be smaller/bigger because…" — and checks whether the prediction was right.
...
### l1 levers e2 — heavier load, more effort

_Experiment · physical game · card: L1 Levers e2_

> same lever length, different loads. does lifting a heavier load need more effort?

**How to play**

1. Lever stays at the medium 30cm arm.
2. Children hang a 0.5kg load, take a reading.
3. Swap to 1kg, take a reading.
4. Compare — is the spring scale number bigger when the load is heavier?
5. First use: discover the pattern.
6. Second use: predict before every reading.

**Difficulty**

- **Easy:** Teacher reads the card. Child hangs the load. Child reads one number aloud.
- **Medium:** Child sets up and records every reading in the table.
- **Hard:** Child predicts the reading within 100g before measuring. Checks how close the prediction was.
...
1. Place fulcrum at the centre of the 30cm lever.
2. Hang 0.5kg on the left.
3. Hang 0.5kg on the right.
4. Does the lever sit flat?
5. Now try 1kg each side.
6. Still balanced?
7. First use: children see balance as a pattern.
8. Second use: before hanging, children say "I predict it will balance" and explain why.

**Difficulty**

- **Easy:** Teacher demonstrates. Child hangs the second weight and watches.
- **Medium:** Child sets up and checks if the lever is level using the table edge as a reference.
- **Hard:** Child predicts balance before hanging each weight and explains why balance happens.
...
_Experiment · physical game · card: L1 Levers e4_

> you do not need a weighing set — any two things that weigh the same will balance a lever.

**How to play**

1. Hang a known 0.5kg weight on one side.
2. On the other side, try objects of different sizes but roughly equal weight — a filled water bottle, a book, a bag of rice.
3. Which makes the lever balance?
4. Children feel that shape and size do not matter — only weight does.
5. First use: discover the idea.
6. Second use: predict which object will balance before trying.

**Difficulty**

- **Easy:** Teacher hangs the comparison objects. Child names which balanced.
- **Medium:** Child tests each object and writes the result in the table.
- **Hard:** Child predicts for each object before testing and explains why shape does not matter.
...
### l1 pulleys e1 — heavier load, more pulley effort

_Experiment · physical game · card: L1 Pulleys e1_

> a single pulley does not make things lighter — heavier loads still need more effort.

**How to play**

1. Clamp the pulley to the table.
2. Thread the rope over it.
3. Tie one end to the load cup, attach the spring scale to the other end.
4. Lift 0.5kg, read the spring scale.
5. Lift 1kg, read again.
6. Compare.
7. First use: discover.
8. Second use: predict before every lift.

**Difficulty**

- **Easy:** Teacher lifts. Child reads the number.
- **Medium:** Child lifts slowly and steadily, takes two readings, writes the average.
- **Hard:** Child predicts the reading before every lift and explains why it will be bigger or smaller.
...
### l1 pulleys e2 — changes direction of pull

_Experiment · physical game · card: L1 Pulleys e2_

> without the pulley you lift up. with the pulley you pull down. same load, different direction.

**How to play**

1. First, lift the 1kg load straight up by hand using the spring scale.
2. Then thread rope over the pulley, hook load on one end, pull the other end down.
3. Child feels: now I pull down to lift the load up.
4. The pulley changes direction.
5. First use: discover the direction switch.
6. Second use: predict "which direction will I pull this time?" before setting up.

**Difficulty**

- **Easy:** Child pulls in the direction shown by the teacher.
- **Medium:** Child sets up the pulley and names the direction of pull each time.
- **Hard:** Child predicts and explains why the direction changes.
...
### l1 pulleys e3 — pulley height does not change effort

_Experiment · physical game · card: L1 Pulleys e3_

> raise the pulley higher. does the spring scale read a bigger number?

**How to play**

1. Clamp the pulley at table-edge height.
2. Lift 1kg, take the reading.
3. Move the pulley to a raised position (use a stack of books under the mount, or raise the clamp).
4. Lift the same 1kg.
5. Compare readings.
6. They are the same.
7. Height does not change effort — only the rope length you pull.

**Difficulty**

- **Easy:** Teacher raises the pulley. Child reads the new number aloud.
- **Medium:** Child raises the pulley position and re-measures.
- **Hard:** Child predicts whether the reading will change before lifting and explains why.
...
### l1 pulleys e4 — pull direction changes comfort, not effort

_Experiment · physical game · card: L1 Pulleys e4_

> pull straight down. pull sideways. does the number on the spring scale change?

**How to play**

1. With load hanging from the pulley rope, child pulls the free end straight down — reads the spring scale.
2. Then pulls at an angle (sideways, 45°).
3. Reads again.
4. The spring scale reading is the same — but one feels more comfortable than the other.

**Difficulty**

- **Easy:** Child pulls in the two directions shown by the teacher.
- **Medium:** Child tries three directions and records all three readings.
- **Hard:** Child predicts whether the readings will match before each pull and explains why comfort is different from effort.
...
- **Easy:** Teacher reads each manual step aloud. Child fits each component and the teacher checks.
- **Medium:** Child reads independently and does each step without verbal confirmation — teacher watches.
- **Hard:** Child works ahead of the manual — reads two steps, plans, then builds. Checks own work before moving on.
...
**PDF reference:** `/robotics-manuals/see-saw.pdf`


### weighing scale build
...
1. The weighing scale is a more precise lever.
...
- **Medium:** Child reads and builds independently.
- **Hard:** Child anticipates the next step before reading and checks own work as they go.
...
**PDF reference:** `/robotics-manuals/weighing-scale.pdf`
...
- **Easy:** Teacher reads steps. Child fits components with check.
- **Medium:** Child reads and builds independently, asks only when genuinely stuck.
- **Hard:** Child plans the next stage, names what the part is for, builds and checks.
...
### Experience Book segment

### experience book

_Experience Book · facilitated_
...
1. The teacher fills in four things per child: the experiment name, the build day, three ability rows (one per skill — B&M, PS, O&U — circling the ability seen clearly today), and one specific note ("worth remembering").
2. The book also carries the Ability Reference, and six monthly Robotics Journey letters that go home at sessions 8, 16, 24, 32, 40, and 48.
3. Always conduct a 3-move debrief: name what you saw (linked to an ability name)
4. name the next step (next ability up)
5. ask one concept question to the group.
...
### l1 levers e1 — longer arm, less effort (qualitative)
...
1. Hang 1kg at the load end.
2. Pull spring scale at the effort end.
3. Take readings for 20cm, 30cm, 40cm arms.
4. Each child takes at least one reading independently.
5. Record every reading.
6. Pair with L2 e1 within the same session — heavier weights, calculate the exact reduction.

**Difficulty**

- **Easy:** Teacher reads the card. Child sets up and records every reading.
- **Medium:** Child reads the card, predicts a direction before each reading, checks.
- **Hard:** Child predicts the ratio of the three readings before testing — "I expect the 40cm to be about half the 20cm" — and checks.
...
### l2 levers e1 — calculate the reduction
...
1. Repeat the lever setup at 20cm, 30cm, 40cm with 2kg load.
2. Fulcrum sits at one-third of lever length from the load end.
3. Read the spring scale at each arm length.
4. Calculate the ratio reading-to-reading.
5. Does doubling the arm length halve the effort reading?
6. Record each calculation in the result table.

**Difficulty**

- **Easy:** Child takes readings. Teacher helps with the arithmetic.
- **Medium:** Child measures and calculates the ratio for each pair of readings.
- **Hard:** Child predicts the 40cm reading from the 20cm reading using the ratio rule before measuring. Records the error.
...
1. Fix the 30cm arm.
2. Take readings at 0.5kg, 1kg, 2kg.
3. Pair with L2 e2 within the same session — calculate whether the increase is proportional.

**Difficulty**

- **Easy:** Child records every reading.
- **Medium:** Child predicts a direction and checks.
- **Hard:** Child predicts the exact reading using doubling — "if 0.5kg reads X, 1kg should read 2X."

**Materials**

- Experiment Card: L1 Levers e2
- PVC pipe 30cm · fulcrum · spring scale · 0.5/1/2kg weights
...
1. Fulcrum at centre of 30cm lever. 0.5kg on each side — balance. 1kg on each side — balance.
2. Record.

**Difficulty**

- **Easy:** Child hangs weights and observes balance.
- **Medium:** Child sets up and writes the rule in their own words.
- **Hard:** Child explains why balance happens using the concept of equal torque (age-appropriate language).
...
1. 0.5kg weight on one side.
2. Try objects of similar weight on the other — a filled bottle, a book, a bag of rice.
3. Which balances?
4. Record.

**Difficulty**

- **Easy:** Child tests each object, records result.
- **Medium:** Child predicts before testing, explains why shape does not matter.
- **Hard:** Child weighs each object on a real scale first, then predicts using the balance rule.
...
1. Use the balance equation to calculate the fulcrum position.
2. Mark the predicted position.
3. Test.
4. How close was the prediction?
5. Repeat with a second weight pair.

**Difficulty**

- **Easy:** Child follows the calculation steps guided by teacher.
- **Medium:** Child solves independently.
- **Hard:** Child solves for three weight pairs and records prediction error for each.

**Materials**

- Experiment Card: L2 Levers e5
- PVC pipe 40cm · fulcrum · 0.5kg + 1kg weights · cups · measuring tape · masking tape · calculator

**PDF reference:** `/robotics-manuals/l2-levers.pdf`


### l2 levers e6 — fulcrum near load, dramatic effort drop
...
1. Place fulcrum at exactly 5cm from the load end on a 40cm lever.
2. Hang 1kg at the load end.
3. Read the spring scale.
4. Calculate the expected reduction using the balance equation.
5. Compare to the actual reading.
6. Discuss class-of-lever (this is a second-class lever — bottle opener, wheelbarrow).

**Difficulty**

- **Easy:** Teacher sets fulcrum. Child reads and names the everyday machine this matches.
- **Medium:** Child sets fulcrum, reads, calculates expected value.
- **Hard:** Child compares to L1 e2 reading and explains the principle of mechanical advantage.

**Materials**

- Experiment Card: L2 Levers e6
- PVC pipe 40cm · fulcrum · 1kg weight · spring scale · measuring tape · calculator

**PDF reference:** `/robotics-manuals/l2-levers.pdf`


### l1 pulleys e1 — heavier load, more effort through a pulley
...
1. Thread rope over a tabletop-clamped pulley.
2. Hang 0.5kg, 1kg, 2kg in turn.
3. Read the spring scale for each.
4. Is the relationship proportional?
5. Record and check.

**Difficulty**

- **Easy:** Child lifts slowly, takes readings.
- **Medium:** Child takes readings and checks proportionality.
- **Hard:** Child predicts the 2kg reading from the 0.5kg reading before testing.

**Materials**

- Experiment Card: L1 Pulleys e1
- Pulley + clamp · rope · spring scale · 0.5/1/2kg weights · cup

**PDF reference:** `/robotics-manuals/l1-pulley.pdf`


### l1 pulleys e2 — pulley changes direction
...
1. Read the spring scale lifting 1kg straight up by hand.
2. Then lift 1kg through a fixed pulley, pulling down.
3. Compare readings.
4. They should be equal — a fixed pulley changes direction, not effort.

**Difficulty**

- **Easy:** Child measures both scenarios.
- **Medium:** Child predicts whether the readings will match before measuring.
- **Hard:** Child explains why they match — the rope carries the same tension on both sides.

**Materials**

- Experiment Card: L1 Pulleys e2
- Pulley · rope · spring scale · 1kg · cup
...
1. Take reading with pulley at low position.
2. Raise pulley.
3. Take reading again with same 1kg load.
4. They match.
5. Raising the pulley changes the rope length pulled, not the force.

**Difficulty**

- **Easy:** Child reads in both positions.
- **Medium:** Child predicts whether the reading will change.
- **Hard:** Child explains why height does not change effort using tension.

**Materials**

- Experiment Card: L1 Pulleys e3
- Pulley · rope · spring scale · 1kg · riser
...
1. Record reading pulling straight down.
2. Record reading pulling at an angle.
3. Match — effort reading is the same.
4. Comfort is different.

**Difficulty**

- **Easy:** Child pulls in two directions, records.
- **Medium:** Child tries three angles and records all readings.
- **Hard:** Child explains why only comfort changes — the weight is constant, so the tension must be too.
...
### l2 pulleys e4 — compound pulley, calculate effort reduction
...
1. Set up a compound pulley using two pulleys — one fixed to the mount, one free on the load.
2. Thread rope through both.
3. Lift 2kg.
4. Measure the effort reading and the rope distance pulled.
5. Calculate mechanical advantage (load ÷ effort) and verify it matches the rope-ratio (distance pulled ÷ distance lifted).

**Difficulty**

- **Easy:** Teacher sets up. Child reads and calculates with support.
- **Medium:** Child sets up and calculates the ratio.
- **Hard:** Child predicts the mechanical advantage from the pulley count before measuring.

**Materials**

- Experiment Card: L2 Pulleys e4
- Two pulleys · mount · rope 2m · spring scale · 2kg · cup · measuring tape · calculator

**PDF reference:** `/robotics-manuals/l2-pulley.pdf`


### l2 pulleys e5 — multi-pulley mechanical advantage
...
1. Extend the compound setup to three or four pulley points using available pulleys and couplers.
2. Lift 2kg.
3. Record effort, record rope distance pulled to lift the load 10cm.
4. Calculate mechanical advantage both ways.
5. Discuss: the trade-off is real — less effort, more rope.

**Difficulty**

- **Easy:** Child follows teacher's setup, reads, calculates with support.
- **Medium:** Child sets up and calculates mechanical advantage.
- **Hard:** Child predicts the ratio from the number of rope segments and checks against measurement.

**Materials**

- Experiment Card: L2 Pulleys e5
- All pulleys available · mount · 2m+ rope · spring scale · 2kg · measuring tape · calculator
...
- **Easy:** Child reads the manual and builds with teacher check per step.
- **Medium:** Child reads and builds independently, tests build-as-you-go.
- **Hard:** Child anticipates the function of each sub-assembly before building, predicts failure modes.
...
- **Easy:** Child reads and builds with teacher checks.
- **Medium:** Child builds independently and checks connections as they go.
- **Hard:** Child anticipates each sub-assembly's function and predicts issues before they occur.
...
- **Easy:** Child reads and builds with teacher check per step.
- **Medium:** Child builds independently, tests each subsystem.
- **Hard:** Child proposes the Improve-day change before Day 4, states expected effect, tests, measures.
...
1. Teacher fills four things per child: experiment name, build day, three ability rows (B&M, PS, O&U — one circled per row), and one specific note ("worth remembering").
2. At 8–12 the most valuable notes capture reasoning.
3. The book also carries the Ability Reference and six monthly Robotics Journey letters.
4. Always conduct a 3-move closing debrief: name what you saw
5. name the next step
6. one concept question.
